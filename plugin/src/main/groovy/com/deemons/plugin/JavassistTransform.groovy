...
public class JavassistTransform extends Transform {
    ...
    void transform(Context context, Collection<TransformInput> inputs,
        ...
        inputs.each { TransformInput input ->
            try {
                ...
                input.jarInputs.each {
                    ...
                    String outputFileName = it.name.replace(".jar", "") + '-' +
                        it.file.path.hashCode()
                    def output = outputProvider.getContentLocation(outputFileName, it.contentTypes,
        ...
        project.logger.error(
            "JavassistTransform cast :" + (System.currentTimeMillis() - startTime) /
                1000 +
                " secs");
    }
}